...
if args_attack.global_settings.universal_perturbation_path:
   # pgd_attack.up = torch.load(args_attack.global_settings.universal_perturbation_path)
    ...
    up_aggan = torch.load(args_attack.global_settings.attentiongan_perturbation_path)
    ...
    up_single = torch.load(args_attack.global_settings.single_path)
    pgd_attack.up = up_single
